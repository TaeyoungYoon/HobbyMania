<?php
    ...
    require_once ($root.'/board/option.php');
...
END;
    ...
    <head>
        ...
        <script src="../inc/jquery.bpopup.min.js"></script>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <ul class="navbar-nav" id="sub_header" >
                        <li class="nav-item"><a href="boardPage.php" class="nav-link">전체 게시판</a></li>
                        {$sub_html}
                    </ul>
                {$LoginPart}
            </div>
